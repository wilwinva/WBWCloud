...
import { SpaDataSet_data } from './__generated__/SpaDataSet';
...
const getVerificationStatus = (data: SpaDataSet_data['data_set_tbvs']) => {
...
interface ImportantNotesProps {
  data: SpaDataSet_data;
}

export default function SpaImportantNotes(props: ImportantNotesProps) {
  const { data } = props;
