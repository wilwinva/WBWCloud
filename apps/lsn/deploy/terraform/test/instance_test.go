...
var LSNADAUTH = os.Getenv("NWMLSNADAUTH")
...
func TestIT_IISPage(t *testing.T) {
	...
	//   This is currently necessary due to the way that the front door grabs the publip ips from the VMs created previously.
